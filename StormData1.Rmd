...
datafile$propdmgexp <- as.factor(datafile$propdmgexp)
datafile$propdmgexp <- factor(datafile$propdmgexp,levels = c(levels(datafile$propdmgexp),1,1000,1000000,1000000000))
datafile$propdmgexp[datafile$propdmgexp==""] <- "1"
datafile$propdmgexp[datafile$propdmgexp=="K"] <- "1000"
datafile$propdmgexp[datafile$propdmgexp=="M"] <- "1000000"
datafile$propdmgexp[datafile$propdmgexp=="B"] <- "1000000000"
